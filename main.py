...
# 1. キャラクターの読み込み
print(">>> キャラクター読み込み開始")
burst3_nikke = create_character_from_json('characters/アリス.json', skill_level=10)
burst3_nikke_2 = create_character_from_json('characters/キリ.json', skill_level=10)
burst2_nikke = create_character_from_json('characters/エヌ：ミラクルフェアリー.json', skill_level=10)
...
# 3. 編成リスト作成 
# 例: 2B単独テスト + ダミー
all_characters = [dummy_b1, dummy_b2, burst3_nikke, dummy_b3, burst2_nikke_2]

# 4. バーストローテーション
rotation = [
    [dummy_b1],
    [dummy_b2,burst2_nikke_2],
